# Telegram-бот для преобразований изображений

## Описание
В учебном проекте реализован простейший Telegram-бот для совершения манипуляций над изображениями
...
Отправьте изображение, введите ключ и число (если требуется) и получите преобразованное изображение

***Повторить последние действия столько раз, сколько нужно :)***
